...
from opengnn.utils.attention_wrapper import BahdanauAttention, AttentionWrapper
...
def build_cell(num_units,
    ...
    if attention_mechanism_fn is not None:
        ...
        extend_attention_mechanism = attention_mechanism_fn(
            num_units,
            extend_memory,
